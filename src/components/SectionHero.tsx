...
type SectionHeroProps = {
  ...
  onHeroWarmupProgress?: (progress: number) => void;
  onHeroWarmupComplete?: () => void;
};

export default function SectionHero({ onHeroWarmupProgress, onHeroWarmupComplete, mediaEnabled = true }: SectionHeroProps) {
  return (
    <section className="hero-section min-h-screen w-full relative overflow-hidden flex items-center bg-surface-dark text-on-dark">
      ...
      <HeroVideoLayer mediaEnabled={mediaEnabled} onWarmupProgress={onHeroWarmupProgress} onWarmupComplete={onHeroWarmupComplete} />
