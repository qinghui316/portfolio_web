...
export default function SectionHero({ onHeroWarmupProgress, onHeroWarmupComplete }: SectionHeroProps) {
  return (
    <section className="hero-section min-h-screen w-full relative overflow-hidden flex items-center bg-surface-dark text-on-dark">
      ...
      <HeroVideoLayer onWarmupProgress={onHeroWarmupProgress} onWarmupComplete={onHeroWarmupComplete} />
